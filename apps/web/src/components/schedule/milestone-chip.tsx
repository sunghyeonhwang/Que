 ...
 * 일반 일정 칩(11px)보다 큰 13px, 폰트 컬러 #004466(밝은 그라데이션 위 가독), 높이 여유.
 */
export function MilestoneChip({ milestone }: { milestone: CalendarMilestone }) {
  ...
  return (
    <div
      ...
      className={cn(
        "que-shimmer-btn flex min-h-8 items-center gap-1 truncate rounded px-2 py-1 text-[13px] font-semibold",
