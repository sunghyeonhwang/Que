        ...
        <div className="mt-3 rounded-lg border border-[var(--que-warning)]/30 bg-[var(--que-warning-bg)] p-3">
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={copy}
              className="flex h-9 shrink-0 items-center gap-1.5 rounded-lg border border-[var(--que-border-strong)] bg-[var(--que-bg)] px-3 text-sm font-medium text-[var(--que-text-secondary)] hover:bg-[var(--que-bg-muted)]"
            >
              {copied ? (
                <>
    ...
    <li className="flex flex-wrap items-center gap-2 rounded-lg border border-[var(--que-border)] px-3 py-2.5">
      ...
      <form action={formAction}>
        ...
        <button
          type="submit"
          disabled={pending}
          className="flex h-9 items-center gap-1.5 rounded-lg border border-[var(--que-border-strong)] px-3 text-sm font-medium text-[var(--que-text-secondary)] hover:bg-[var(--que-bg-muted)] disabled:opacity-60"
        >
