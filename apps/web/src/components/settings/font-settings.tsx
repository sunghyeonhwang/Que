...
/** 한글/영문 폰트 별도 선택. 선택 즉시 화면 반영(html data-attr) + 쿠키 저장(다음 로드 SSR). */
export function FontSettings({
  ...
  function apply(kind: "ko" | "latin", value: string) {
    ...
    document.cookie = `font-${kind}=${value}; path=/; max-age=${YEAR}; samesite=lax`;
  ...
  return (
    <section className="flex flex-col gap-6">
      <div className="rounded-xl border border-[var(--que-border)] bg-white p-5 shadow-[var(--que-shadow-sm)]">
            ...
            <button
              ...
              className={cn(
                ...
                active
                  ...
                  : "border-[var(--que-border)] bg-white hover:bg-[var(--que-bg-muted)]",
              )}
            >
