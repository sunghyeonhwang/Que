...
| **2. AI 진행자+리듬** | AI 팀 요약(pro)+standup_team_summaries + 알림 시간표 재편(§5) + 10:40 재촉 + /team 스탠드업 대체 + **대화형 체크인(a)** | 중 |
| **3. OKR 코어** | objectives/key_results 전 스택 + OKR 탭 + Task.keyResultId + 하이브리드 진척 계산기 | 대 |
| **2.5 마일스톤 회의 AI 원격 진행 + 스탠드업 라이브 진행** | §1-c + §3-b(b) — 안건 큐·순차 호명·버튼 응답(Slack DM 병행)·회의록/요약 자동화(공유 인프라) | 중소 |
